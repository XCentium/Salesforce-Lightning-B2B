...
import getCartSummary from '@salesforce/apex/XC_LWC_CartCtrl.getCartSummary';
import getDiscount from '@salesforce/apex/XC_LWC_CartCtrl.getDiscount';
...
export default class CartSummary extends LightningElement {
    ...
    get labels() {
        return {
            cartSummaryHeader: 'Cart Summary',
            subTotal: 'Sub Total',
            discount: 'Discount',
            total: 'Total'
        };
    ...
    get prices() {
        return {
            ...
            finalPrice: this.cartSummary && (this.cartSummary.totalProductAmount - this.discount),
            subTotal: this.cartSummary && this.cartSummary.totalProductAmount,
            totalDiscount: -1 * this.discount
        };
    }
    ...
    calculateDiscount() {
        calculateDiscount({
            ...
            this.discount = result.totalDiscount;
            this.hasDiscount = 0 != result.totalDiscount;
    ...
    applyPromo() {
        ...
        .catch(error => {
            ...
            this.hasDiscount = false;
            this.getUpdatedCartSummary();
            fireEvent(this.pageRef, COUPON_REMOVE_EVT);
        });
    }
